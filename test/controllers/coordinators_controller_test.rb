...
class CoordinatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinator" do
    assert_difference('Coordinator.count') do
      post coordinators_url, params: { coordinator: { registration: @coordinator.registration, user_id: @coordinator.user_id } }, as: :json
    end
  ...
  test "should update coordinator" do
    patch coordinator_url(@coordinator), params: { coordinator: { registration: @coordinator.registration, user_id: @coordinator.user_id } }, as: :json
    assert_response 200
  end
